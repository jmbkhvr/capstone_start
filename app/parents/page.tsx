    ...
    >
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <div>
              ...
              >
                Module 3 • Review & Authorize Parent Accounts
              </p>
            </div>
        ...
        <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
          ...
          <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
            ...
            <form onSubmit={handleSearchSubmit} className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className={`w-full text-xs pl-10 pr-20 py-2.5 rounded-2xl border focus:outline-none focus:ring-2 transition-all ${
                  isChild
          ...
          {/* ---------------------------------------------------------------- */}
          <div
            className={`rounded-3xl border shadow-md overflow-hidden transition-all duration-300 ${
                    ...
                    {parents.map((parent) => (
                      <tr
                        ...
                        className={`transition-colors ${
                          isChild ? 'hover:bg-teal-50/40' : 'hover:bg-slate-800/30'
                        }`}
                      >
                        {/* Parent Name */}
