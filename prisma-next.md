...
Your data contract is the heart of your application. It lives at [`capstone_start/prisma/contract.prisma`](capstone_start/prisma/contract.prisma) and describes your models:
...
```typescript
import { db } from './capstone_start/prisma/db';
...
export default definePrismaConfig({
  orm: ormConfig({
    contract: './capstone_start/prisma/contract.prisma',
    db: {
...
| File | Purpose |
|---|---|
| [`capstone_start/prisma/contract.prisma`](capstone_start/prisma/contract.prisma) | Your data contract — define your models here |
| [`prisma.config.ts`](prisma.config.ts) | CLI configuration |
| [`capstone_start/prisma/db.ts`](capstone_start/prisma/db.ts) | Database client — `import { db } from './capstone_start/prisma/db'` |
| `capstone_start/prisma/contract.json` | Compiled contract (generated) |
| `capstone_start/prisma/contract.d.ts` | Contract types (generated) |

### Workflow

1. Edit [`capstone_start/prisma/contract.prisma`](capstone_start/prisma/contract.prisma) to add or change models.
